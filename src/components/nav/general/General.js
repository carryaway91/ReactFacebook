...
import { Nav, Title, DesktopNav, MobileNav } from './GeneralStyles'
        ...
        <Nav>
            <DesktopNav>
                <NavLink to="/" show={() => setIcon('home')} hide={() => setIcon('')}>
                    { props.main && icon == 'home' &&  <Title>Home</Title> }
                ...
                <NavLink to="/friends" show={() => setIcon('friends')} hide={() => setIcon('')}>
                    { props.main && icon == 'friends' &&  <Title>Friends</Title> }
                ...
                <NavLink to="/pages" show={() => setIcon('pages')} hide={() => setIcon('')}>
                    { props.main && icon == 'pages' &&  <Title>Pages</Title> }
                ...
                <NavLink to="/watch" show={() => setIcon('watch')} hide={() => setIcon('')}>
                    { props.main && icon == 'watch' &&  <Title>Watch</Title> }
                ...
                <NavLink to="/groups" show={() => setIcon('groups')} hide={() => setIcon('')}>
                    { props.main && icon == 'groups' &&  <Title>Groups</Title> }
